  ...
  return (
    <>
      <div className="w-full max-w-3xl mx-auto my-6">
        <h2 className="text-xl font-semibold mb-4 text-gray-900">Transactions (Page {currentPage})</h2>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100">
                <th className="px-4 py-2 text-left font-semibold text-gray-900">Signature</th>
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center">
                        <span 
                          className="text-blue-700 font-medium hover:underline truncate block max-w-[150px] mr-2"
                          title={tx.signature}
                        >
                    ...
                    <td className="px-4 py-3">
                      <span className="text-gray-900 font-medium" title={tx.blockTime ? new Date(tx.blockTime * 1000).toLocaleString() : 'N/A'}>
                    ...
                    <td className="px-4 py-3">
                      ...
                      {tx.memo && (
                        <span className="ml-2 text-xs text-gray-700 font-medium" title={tx.memo}>
