...
if (!walletAddress) {
  console.error('❌ Erreur: Aucune adresse de portefeuille fournie. Utilisez le format: node acc_transactions.js ADDRESS_WALLET');
  process.exit(1);
}
...
fetch(`https://pro-api.solscan.io/v2.0/account/transactions?address=${walletAddress}&limit=40`, requestOptions)
